        ...
        <div className="fixed bottom-6 right-6 z-[1000] flex flex-col items-end gap-3 pointer-events-none">
            ...
            <AnimatePresence>
                {showHint && !isPlaying && (
                    <motion.div
                        ...
                        className="bg-white/90 backdrop-blur-md border border-[#7a1010]/30 rounded-full px-4 py-3 shadow-xl flex items-center gap-3 mb-2"
                        style={{ borderColor: 'rgba(122, 16, 16, 0.3)' }}
                    >
                        <motion.span
                            ...
                            className="text-lg"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-[#591420]">
            ...
            >
                ...
                {isPlaying && (
                    <>
                        <motion.div
                            className="absolute inset-0 rounded-full border border-[#7a1010]/40"
                            animate={{ scale: [1, 1.8], opacity: [0.5, 0] }}
                            transition={{ duration: 2, repeat: Infinity, ease: "easeOut" }}
                            style={{ borderColor: 'rgba(122, 16, 16, 0.4)' }}
                        />
                        <motion.div
                            className="absolute inset-0 rounded-full border border-[#7a1010]/40"
